...
describe('Description', () => {
    ...
    it.skip('should render people 1', async () => {
    ...
    it.skip('should render film 1', async () => {
    ...
    it.skip('should render planet 1', async () => {
        ...
        expect(await screen.findByTestId('surface_water')).toHaveTextContent(
        ...
        expect(await screen.findByTestId('rotation_period')).toHaveTextContent(
        ...
        expect(await screen.findByTestId('orbital_period')).toHaveTextContent(
            'Orbital period: 304'
        )
    ...
    it.skip('should render species 1', async () => {
        renderDescription('/species/1')

        expect(await screen.findByTestId('classification')).toHaveTextContent(
        ...
        expect(await screen.findByTestId('homeworld')).toHaveTextContent(
            'Home world: https://swapi.dev/api/planets/9'
        )

        expect(await screen.findByTestId('average_lifespan')).toHaveTextContent(
            'Average lifespan: 120'
        )

        expect(await screen.findByTestId('average_height')).toHaveTextContent(
            'Average height: 180'
        )
    ...
    it.skip('should render starship 2', async () => {
        ...
        expect(await screen.findByTestId('cargo_capacity')).toHaveTextContent(
        ...
        expect(await screen.findByTestId('cost_in_credits')).toHaveTextContent(
        ...
        expect(await screen.findByTestId('starship_class')).toHaveTextContent(
            'Starship class: corvette'
        )

        expect(
            await screen.findByTestId('hyperdrive_rating')
        ).toHaveTextContent('Hyperdrive rating: 2.0')
    ...
    it.skip('should render vehicle 4', async () => {
        ...
        expect(
            await screen.findByTestId('max_atmosphering_speed')
        ).toHaveTextContent('Max atmosphering speed: 30')
        ...
        expect(await screen.findByTestId('vehicle_class')).toHaveTextContent(
